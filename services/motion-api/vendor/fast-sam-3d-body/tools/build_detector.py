...
class HumanDetector:
    def __init__(self, name="vitdet", device="cuda", **kwargs):
        ...
        if name == "vitdet":
            ...
            # Not upstream -- see tools/rtmo_detector.py and PROVENANCE.md.
            # Replaces yolo_pose: same dict({"boxes", "keypoints"}) contract,
            # Apache-2.0 (rtmlib/mmpose) + MIT (ByteTrack) instead of AGPL-3.0
            # (ultralytics), per docs/PRD.md G2.
            print("########### Using human detector: RTMO + ByteTrack...")
