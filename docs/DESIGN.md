...
- **The pasted-link door has its own rights line, and it is not the upload one with a word changed (added 2026-09-21, `docs/research/link-ingestion.md`).** The line above addresses someone holding a file, who at least *might* hold the right to it — they may have filmed it, may be in it, may have been sent it. Almost nobody pasting a TikTok link has any right to that video at all, so writing "only paste video you have the right to use" would print a sometimes-true sentence over a nearly-always-false case. That is this section's own trap with a new target: not a lie anyone wrote on purpose, an intention read as a claim. The line is:
